...
public class GerenciadorDeLocalizacao : MonoBehaviour
{
    ...
    private void CarregarTextosLocalizados()
    {
        ...
        {
            textosLocalizados.Clear(); // Limpa o dicion�rio antes de carregar novos textos
        }
        ...
        if (File.Exists(caminho))
        {
            ...
            Debug.Log("Conte�do JSON: " + conteudoJson); // Log para verificar o conte�do do JSON
        ...
        {
            Debug.LogError($"Arquivo de localiza��o n�o encontrado: {caminho}");
        }
    }
    ...
    public string ObterTextoLocalizado(string chave)
    {
        if (textosLocalizados == null)
        {
            Debug.LogError("TextosLocalizados n�o foi inicializado.");
            return null;
        }
        ...
        Debug.LogWarning($"Texto n�o encontrado para a chave: {chave}");
        return null;
    }
    ...
    {
        // Envia um evento ou chama um m�todo para atualizar os textos na UI
